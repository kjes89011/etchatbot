...
class SpellingCheck:
	def __init__(self,language,):
		...
		self.spell_check = enchant.checker.SpellChecker(language)

	def chec(self,input_sentence):
		s_c = enchant.checker.SpellChecker(self.language)
		s_c.set_text(input_sentence)
		return s_c


	def spellCheckDialoge(input_sentence):
		spell_check = check(input_sentence)
